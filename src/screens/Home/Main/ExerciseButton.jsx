    ...
    return (
        <View style={styles.container}>
            <View style={styles.leftColumn}>
                <TouchableOpacity style={styles.healthAndRunning} onPress={() => navigation.navigate("HrvBefore", { button: '헬스' })}>
                ...
                <TouchableOpacity style={styles.healthAndRunning} onPress={() => navigation.navigate("HrvBefore", { button: '러닝' })}>
                    <View style={styles.textBox}>
